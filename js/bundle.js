...
function forms(formSelector, modalTimerId) {
    ...
    function bindPostData(form) {
        form.addEventListener('submit', (e) => {
            ...
            (0,_services_services__WEBPACK_IMPORTED_MODULE_1__.postData)('http://localhost:3000/requests', json/*JSON.stringify(object) - для работы с JSON /*formData - если работаем с форм датой*/)
            .then(data => {
                console.log(data);
...
window.addEventListener('DOMContentLoaded', function() {
    ...
    (0,_modules_timer__WEBPACK_IMPORTED_MODULE_6__.default)('.timer', '2021-07-31');
